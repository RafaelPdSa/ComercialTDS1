...
namespace ComercialTDSDesk
{
    public partial class FrmPedido : Form
    {
        ...
        private void CarregarItems(int pedidoId)
        {
            ...
            txtSubTotalItens.Text = (subTotal + descontos).ToString();
        ...
        private void txtIdPedido_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if (pedido.Id > 0)
                {
                    ...
                    {
                        var resposta = MessageBox.Show("O pedido está fechado.\n Deseja Reabrir?", "Pedido", MessageBoxButtons.YesNo, // botões da mensagme
                        MessageBoxIcon.Question, //icone da mensagem
